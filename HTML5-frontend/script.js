...
/**
 * Case statement that handles what needs to be done on the front end for each
 * phase of the test.
 * @param {integer} that matches against the constants for the front end for
 *     each phase.
 * @return {boolean} if no matching phase constants to @param
 */
